package br.edu.uniritter.mobile.JsonPlaceholderRecyclerView.adapter;
...
import br.edu.uniritter.mobile.JsonPlaceholderRecyclerView.R;
import br.edu.uniritter.mobile.JsonPlaceholderRecyclerView.model.Posts;
...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.PostsViewHolder>{
    ...
    public PostsAdapter.PostsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_detail_posts, parent, false);
